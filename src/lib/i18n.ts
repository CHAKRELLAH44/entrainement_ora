...
export const TRANSLATIONS = {
  fr: {
    ...
    myActivities: "Mes activites",
    mySpeakingSessions: "Mes seances parlees",
    myReadings: "Mes lectures",
    myWritings: "Mes ecrits",
    logout: "Deconnexion",
    settings: "Parametres",
    language: "Langue",
    ...
    writingModule: "Module d'ecriture",
    randomTopic: "Sujet aleatoire choisi",
    noTimer: "Pas de minuteur, ecris a ton rythme",
    writeMinimum: "Ecris au minimum 100 mots",
    aiCorrection: "Correction automatique avec IA",
    writingHistory: "Historique de tes ecrits sauvegarde",
    practiceWriting: "Pratique l'expression ecrite",
    ...
    express: "S'exprimer",
    expressionModule: "Module d'expression",
    myExpressions: "Mes expressions",
    watchAndComment: "Regarde et exprime-toi",
    recordYourOpinion: "Enregistre ton avis sur ce que tu vois",
    expressionSessions: "Mes seances d'expression",
    noExpressionSessions: "Aucune session d'expression pour l'instant",
  },
  en: {
    appName: "Free Speech",
    hello: "Hello",
    ...
    mySpeakingSessions: "My speaking sessions",
    ...
    writingModule: "Writing module",
    randomTopic: "Random topic selected",
    noTimer: "No timer, write at your own pace",
    writeMinimum: "Write at least 100 words",
    aiCorrection: "Automatic AI correction",
    writingHistory: "Your writing history saved",
    practiceWriting: "Practice written expression",
    ...
    expressionModule: "Expression module",
    myExpressions: "My expressions",
    watchAndComment: "Watch and share your thoughts",
    recordYourOpinion: "Record your opinion on what you see",
    expressionSessions: "My expression sessions",
    noExpressionSessions: "No expression sessions yet",
  },
  es: {
    appName: "Habla Libre",
    hello: "Hola",
    ...
    mySpeakingSessions: "Mis sesiones orales",
    myReadings: "Mis lecturas",
    myWritings: "Mis escritos",
    ...
    writingModule: "Modulo de escritura",
    randomTopic: "Tema aleatorio seleccionado",
    noTimer: "Sin temporizador, escribe a tu ritmo",
    writeMinimum: "Escribe al menos 100 palabras",
    aiCorrection: "Correccion automatica con IA",
    writingHistory: "Historial de tus escritos guardado",
    practiceWriting: "Practica la expresion escrita",
    ...
    inProgress: "En curso",
    express: "Expresarse",
    expressionModule: "Modulo de expresion",
    myExpressions: "Mis expresiones",
    watchAndComment: "Mira y comparte tu opinion",
    recordYourOpinion: "Graba tu opinion sobre lo que ves",
    expressionSessions: "Mis sesiones de expresion",
    noExpressionSessions: "Sin sesiones de expresion por ahora",
